...
class ProyectoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        session()->flash('status', 'Persona Registrada con exito');
    ...
    public function update(Request $request, $proyecto)
    {
        ...
        return to_route('proyectos.index')->with('status', 'Persona actualizada con exito');
    }

    public function destroy(Proyecto $proyecto)
    {
        $proyecto->delete();
        return to_route('proyectos.index')->with('status', 'Persona eliminada');
    }
